...
function FormularioCadastro() {
    ...
    const cadastrarUsuario = async () => {
        try {
            const response = await axios.post('https://tcc-backend-f168.onrender.com/tab_jogadores, {nome, sexo, idade, altura, peso, posicao, numeroCamisa})
